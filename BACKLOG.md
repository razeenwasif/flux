...
| 113 | P2 | **Advanced PDF editing** — follow-ups to the #112 editor (markup + page-ops shipped): AcroForm **form fill + save**, true **in-place text editing** (reconstruct text runs — inherently fragile), **OCR** for scanned PDFs (Tesseract/wasm), cryptographic **digital signatures**, and redaction-with-guarantees | Adobe Acrobat |
