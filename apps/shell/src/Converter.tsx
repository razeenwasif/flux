...
const CATS: Cat[] = [
  ...
  {
    name: "Mass",
    units: { kg: 1, g: 0.001, mg: 1e-6, t: 1000, lb: 0.45359237, oz: 0.028349523125, st: 6.35029318 },
  },
  ...
  {
    name: "Speed",
    units: { "m/s": 1, "km/h": 0.277777778, mph: 0.44704, knot: 0.514444444, "ft/s": 0.3048 },
  },
  {
    name: "Time",
    units: { sec: 1, min: 60, hour: 3600, day: 86400, week: 604800, ms: 0.001, year: 31557600 },
  },
  ...
  return (
    <div classList={{ conv: true, "conv-full": !!props.full }}>
      ...
      >
        <div class="conv-tabs">
          <For each={CATS}>
            {(c) => (
              <button
                classList={{ "conv-tab": true, on: c.name === catName() }}
      ...
      <div class="conv-body">
        ...
        <button class="conv-swap" title="Swap" onClick={swap}>
          ⇅
        </button>
        <div class="conv-side">
          <div class="conv-result" title={result()}>
            {result()}
          </div>
        ...
        <div class="conv-note">
          {rates.loading
            ...
            : rates()
              ...
              : "Couldn't fetch rates — check your connection."}
        </div>
      </Show>
    </div>
  );
