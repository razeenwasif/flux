...
| 58 | P1 | **HTTPS-only** ✅ + **cookie clear** ✅ + **tracking prevention** ✅ (native WebView2 3rd-party tracker/cookie blocking, Off/Basic/Balanced/Strict). + **clear-on-close** ✅. All via the #91 interceptor / WebView2 profile, Shields-popover controls, verified vs msvc. **Remaining: per-site permission prompts (camera/mic/geo) + a downgrade interstitial.** | Brave, Firefox |
