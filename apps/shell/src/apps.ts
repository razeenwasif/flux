 ...
 *
 * Desktop-only: on mobile the app dock/rail is hidden (ADR 0012), so the list is
 * empty there. Edit DESKTOP_APPS below to change your pinned apps.
 */
...
export const FLUX_APPS: FluxApp[] = isMobile ? [] : DESKTOP_APPS;
